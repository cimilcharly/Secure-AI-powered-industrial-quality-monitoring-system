...
# Fine-tuned tight bounding boxes based on the visual verification
CALIBRATED_BOXES_V2 = {
    # 1. Broken stitch (1264 x 848)
    # The broken stitch on beige back yoke is to the left of the center pleat
    'stitch_broken_back_yoke_seam.jpg': (220, 160, 310, 205),
    ...
    'stitch_broken_shoulder_seam.jpg': (380, 80, 470, 140),
    ...
    # Hanging thread from collar neckline (was perfect)
    ...
    # Open dark gap on light blue back yoke (was perfect)
    'stitch_open_seam_back_yoke_seam_1789635312289.jpg': (525, 155, 680, 190),
    # Open separated seam on maroon collar (was perfect)
    'stitch_open_seam_collar_seam_1789635295024.jpg': (665, 125, 715, 210),
    # Dark open seam gap on white side seam (was perfect)
    'stitch_open_seam_left_side_seam_1789635243298.jpg': (425, 425, 460, 575),
    # Dark open underarm sleeve gap on navy shirt
    'stitch_open_seam_left_sleeve_seam_1789635273374.jpg': (880, 430, 960, 540),
    # Dark open seam gap on black side seam (was perfect)
    ...
    'stitch_zigzag_back_yoke_seam.jpg': (315, 155, 450, 215),
    # Errant zigzag stitches on grey collar lapel edge
    'stitch_zigzag_collar_seam.jpg': (530, 125, 585, 210),
    # Errant zigzag stitches along black left side seam
    'stitch_zigzag_left_side_seam.jpg': (335, 520, 395, 670),
    # Errant zigzag stitch run along navy right side seam
    'stitch_zigzag_right_side_seam.jpg': (648, 470, 690, 610),
    # Massive zigzag stitch cluster on navy fabric (was perfect)
    'stitch_zigzag_shoulder_seam.jpg': (380, 220, 640, 640),
    # Errant zigzag stitches along white sleeve seam
    'stitch_zigzag_sleeve_seam.jpg': (170, 600, 255, 740),
}

crops_list = []
for fname, box in CALIBRATED_BOXES_V2.items():
...
out_p = os.path.join(ARTIFACT_DIR, "all_24_calibrated_stitch_boxes_v2.jpg")
cv2.imwrite(out_p, final_vis)
print(f"Calibration preview v2 saved to {out_p}")
